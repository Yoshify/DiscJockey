...
public class FormatData
{
    ...
    [JsonProperty("stretched_ratio")] public float? StretchedRatio { get; set; }

    [JsonProperty("no_resume")] public bool? NoResume { get; set; }

    [JsonProperty("has_drm")] public string HasDRM { get; set; }

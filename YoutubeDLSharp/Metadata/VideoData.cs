...
public class VideoData
{
    ...
    [JsonProperty("entries")] public VideoData[] Entries { get; set; }

    [JsonProperty("id")] public string ID { get; set; }

    [JsonProperty("title")] public string Title { get; set; }

    [JsonProperty("formats")] public FormatData[] Formats { get; set; }
    ...
    [JsonProperty("player_url")] public string PlayerUrl { get; set; }

    //optional fields
    [JsonProperty("direct")] public bool Direct { get; set; }

    [JsonProperty("alt_title")] public string AltTitle { get; set; }

    [JsonProperty("display_id")] public string DisplayID { get; set; }

    [JsonProperty("thumbnails")] public ThumbnailData[] Thumbnails { get; set; }
    ...
    [JsonProperty("subtitles")] public Dictionary<string, SubtitleData[]> Subtitles { get; set; }

    [JsonProperty("automatic_captions")] public Dictionary<string, SubtitleData[]> AutomaticCaptions { get; set; }
    ...
    [JsonProperty("dislike_count")] public long? DislikeCount { get; set; }

    [JsonProperty("repost_count")] public long? RepostCount { get; set; }

    [JsonProperty("average_rating")] public double? AverageRating { get; set; }

    [JsonProperty("comment_count")] public long? CommentCount { get; set; }

    [JsonProperty("comments")] public CommentData[] Comments { get; set; }
    ...
    [JsonProperty("playable_in_embed")] public string PlayableInEmbed { get; set; }

    [JsonConverter(typeof(StringToEnumConverter<Availability>))]
    [JsonProperty("availability")]
    public Availability? Availability { get; set; }

    [JsonProperty("chapters")] public ChapterData[] Chapters { get; set; }

    [JsonProperty("chapter")] public string Chapter { get; set; }

    [JsonProperty("chapter_number")] public int? ChapterNumber { get; set; }

    [JsonProperty("chapter_id")] public string ChapterId { get; set; }
    ...
    [JsonProperty("episode")] public string Episode { get; set; }

    [JsonProperty("episode_number")] public int? EpisodeNumber { get; set; }

    [JsonProperty("episode_id")] public string EpisodeId { get; set; }
    ...
    [JsonProperty("album_artist")] public string AlbumArtist { get; set; }

    [JsonProperty("disc_number")] public int? DiscNumber { get; set; }

    [JsonProperty("release_year")] public string ReleaseYear { get; set; }

    [JsonProperty("composer")] public string Composer { get; set; }

    [JsonProperty("section_start")] public long? SectionStart { get; set; }

    [JsonProperty("section_end")] public long? SectionEnd { get; set; }

    [JsonProperty("rows")] public long? StoryboardFragmentRows { get; set; }

    [JsonProperty("columns")] public long? StoryboardFragmentColumns { get; set; }
